...
█═════════════════════════════════█
█ [${blanco}02${verde}] ┃ ${blanco}PruebaMls    ${verde}┃ ${blanco}Google    ${verde}█
█═════════════════════════════════█
...
termux-open https://www.mycyber.tools/register.php
elif [[ $webpage == 2 || $webpage == 02 ]]; then
termux-open https://pruebamls.000webhostapp.com/mail/
elif [[ $webpage == 3 || $webpage == 03 ]]; then
termux-open https://error404emailprueba.000webhostapp.com/
elif [[ $webpage == 4 || $webpage == 04 ]]; then
termux-open https://pruebaemailspoof.000webhostapp.com/
elif [[ $webpage == 5 || $webpage == 05 ]]; then
termux-open https://github.com/TermuxHacking000/Falsify
else
echo -e "${rojo}
┌═════════════════════┐
